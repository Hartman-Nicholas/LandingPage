...
export default function GuideLines() {
  ...
  return (
    <section className="homePage">
      <div>
        <h2 className="homePage--heading">Community GuideLines</h2>

        <h3 className="homePage--subHeading">The Short Version</h3>
        ...
        <h3 className="homePage--subHeading">Rules of the road</h3>
        <ul className="homePage__list">
          <li className="homePage__list--item">
          ...
          <li className="homePage__list--item">
            ...
            helpful and it doesn’t make Landing Page a friendly place. This
          ...
          <li className="homePage__list--item">
            ...
            conversations here at Landing Page, we will take your comments and
